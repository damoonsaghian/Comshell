...
class DirectoryView {
  constructor(directory) {
    ...
    this.subscriptions.add(this.directory.onDidDestroy(
  ...
  updateIcon() {
    ...
    if (this.directory.symlink) {
      ...
      if (this.directory.isRoot) {
        ...
        if (this.directory.submodule) iconClass = 'icon-file-submodule';
      }
    }
    classes.push(iconClass);
    this.directoryName.classList.add(...classes);
  }
  ...
  reload() {
    if (this.isExpanded) this.directory.reload();
  }
