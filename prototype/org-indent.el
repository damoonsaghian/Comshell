;; a small modification on the original org-indent.
...
(define-globalized-minor-mode global-org-indent-mode org-indent-mode (lambda () (org-indent-mode 1)))
...
Assume point is at beginning of line."
  (let ((line (cond
	...
	(wrap (concat "  "  (aref org-indent-strings (min w org-indent-max)))))
