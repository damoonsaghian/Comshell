...
/*
define a new command (and bind it) which first checks
  if the entry is a directory containing a ".gallery" file,
  if so, open gallery, if not, call the default command;
